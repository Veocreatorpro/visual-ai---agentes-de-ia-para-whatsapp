      ...
      >
        <div className="flex flex-col lg:flex-row min-h-[480px]">
          ...
          <div className="p-8 md:p-12 lg:p-14 flex-1 flex flex-col justify-center">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-[3.5rem] font-bold text-slate-900 leading-[1.1] mb-5">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              <a href="#integracoes" className="px-7 py-3.5 bg-slate-50 text-slate-900 font-semibold rounded-xl border border-slate-200 hover:bg-slate-100 transition-colors text-center text-sm">
                Como funciona
              </a>
            </div>
          </div>
          ...
          <div className="flex-1 relative min-h-[320px] lg:min-h-full bg-slate-900 overflow-hidden">
            {/* Background image */}
            ...
            <div className="absolute inset-0 flex items-center justify-center p-6">
              <div className="w-full max-w-[320px]">
                <div className="bg-white/95 backdrop-blur-md rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
                  {/* Chat header */}
                  <div className="flex items-center gap-2.5 p-3 border-b border-slate-100 bg-white">
                    <div className="w-9 h-9 bg-green-500 text-white rounded-full flex items-center justify-center shadow-sm">
                      <MessageCircle size={16} />
                    </div>
                    <div>
                      <h4 className="text-xs font-bold text-slate-900">Agente Visual AI</h4>
                    ...
                    <AnimatePresence>
                      {chatMessages.slice(0, visibleMessages).map((msg, i) => (
                        <motion.div
                          ...
                          className={`text-[11px] leading-relaxed p-2 rounded-lg max-w-[88%] ${
                            msg.role === 'user'
                              ? 'bg-slate-100 text-slate-800 rounded-tr-sm ml-auto'
