    ...
    <section className="py-8 max-w-7xl mx-auto px-4">
      ...
      >
        <div className="text-center max-w-3xl mx-auto mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">Do "Oi" ao Orçamento em 2 minutos</h2>
          <p className="text-lg text-slate-600">Veja como a Visual AI transforma um contato desestruturado em uma ordem de serviço pronta para sua equipe.</p>
        </div>

        <div className="flex flex-col md:flex-row items-center justify-center gap-8 relative">
          {/* Step 1 */}
          <div className="flex-1 bg-slate-50 border border-slate-200 p-6 rounded-3xl w-full relative z-10">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 bg-slate-200 rounded-full flex items-center justify-center text-slate-600">
                <MessageSquare size={20} />
              </div>
              <h3 className="font-bold text-slate-900">1. O Cliente</h3>
            </div>
            <div className="bg-white p-4 rounded-2xl rounded-tl-none shadow-sm border border-slate-100 text-sm text-slate-700 mb-2">
              "Meu celular caiu na água e não liga mais, quanto custa pra arrumar?"
            </div>
            <p className="text-xs text-slate-500 mt-4">Mensagem genérica, sem modelo ou detalhes.</p>
          </div>
          ...
          <div className="flex-1 bg-blue-50 border border-blue-100 p-6 rounded-3xl w-full relative z-10">
            ...
            <div className="bg-white p-4 rounded-2xl rounded-tr-none shadow-sm border border-blue-100 text-sm text-slate-700 mb-2">
          ...
          <div className="flex-1 bg-emerald-50 border border-emerald-100 p-6 rounded-3xl w-full relative z-10">
            ...
            <div className="bg-white p-4 rounded-2xl shadow-sm border border-emerald-100 text-sm text-slate-700">
