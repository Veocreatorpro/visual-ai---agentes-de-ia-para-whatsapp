    ...
    <section id="solucao" className="py-8 max-w-6xl mx-auto px-4">
      <div className="grid md:grid-cols-2 gap-6">
        <motion.div 
          ...
          className="bg-white rounded-[2rem] p-8 md:p-12 shadow-xl border border-slate-100 flex flex-col justify-center"
        >
          <h2 className="text-2xl md:text-3xl font-bold text-slate-900 mb-4">Inteligência focada em assistência técnica</h2>
          <p className="text-slate-600 text-sm mb-8">Treinamos a IA com o catálogo de serviços, peças e regras de negócio da sua loja. Ela atende como o seu melhor vendedor.</p>
        ...
        <motion.div 
          ...
          whileInView={{ opacity: 1, x: 0 }}
          viewport={{ once: false, margin: "-100px" }}
          className="rounded-[2rem] overflow-hidden shadow-xl relative min-h-[300px]"
        >
